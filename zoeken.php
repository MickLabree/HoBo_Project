  ...
  <header>
    <nav>
      <ul>
        ...
        <li><a href="#" style="margin-right: 20px;"><i class="fa-solid fa-user"></i></a><a href="#"><i
  ...
  <section id="footer">
    <article class="footer-links">
      ...
      <p>
        ...
        watch tv shows online free in high quality for free. You can also download full tv shows and watch it later if
        you want.
      </p>
